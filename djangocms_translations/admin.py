...
from .forms import TranslationDirectiveAdminForm
...
class AppTranslationRequestAdmin(AllReadOnlyFieldsMixin, admin.ModelAdmin):
    ...
    def get_urls(self):
        return [
            ...
            path(
                'add/',
                views.CreateAppTranslationRequestView.as_view(),
                name='create-app-translation-request',
            ),
            path(
                '<int:pk>/get-app-quote-from-provider/',
                views.get_quote_from_provider_view,
                name='get-app-quote-from-provider',
            ),
            path(
                '<int:pk>/choose-app-quote/',
                views.ChooseAppTranslationQuoteView.as_view(),
