...
DEFAULT_TRANSLATION_PROVIDER = getattr(settings, 'DEFAULT_TRANSLATION_PROVIDER', None)
DEFAULT_TRANSLATION_SOURCE_LANGUAGE = getattr(settings, 'DEFAULT_TRANSLATION_SOURCE_LANGUAGE', "de")
